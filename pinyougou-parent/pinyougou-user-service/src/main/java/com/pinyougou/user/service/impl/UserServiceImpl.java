...
public class UserServiceImpl implements UserService {
    ...
    @Value("${activeMQ.template_code}")
    private String templateCode;

    @Value("${activeMQ.sign_name}")
    ...
    public void createSmsCode(final String phone) {
        ...
        while (smsCode.length() < 6) {//6位验证码
            smsCode = "0" + smsCode;
        }
        System.out.println(smsCode);
        Map paramMap = new HashMap();
        paramMap.put("code", smsCode);
        final String param = JSON.toJSONString(paramMap);
        //2.存入redis
        ...
        jmsTemplate.send(smsDestination, new MessageCreator() {
            ...
            public Message createMessage(Session session) throws JMSException {
                ...
                message.setString("template_code", templateCode);//模板验证码
                message.setString("sign_name", signName);//签名
                message.setString("param", param);//参数(code)
                return message;
            }
        });
    }
    ...
    public boolean checkSmsCode(String phone, String checkCode) {
        ...
        if (checkCode.equals(smsCode)) {//验证码正确
            return true;
        } else {
            //验证码错误，删除验证码
